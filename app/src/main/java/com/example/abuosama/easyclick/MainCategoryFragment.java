...
public class MainCategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.recyclerviewdetails);
...
//        lon1 = bundle.getString("lon");
       ...
       // lon1 = getArguments().getString("lon");
        ...
        myRecyclerAdapter = new MyRecyclerAdapter(halllist,getContext());
    ...
    public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyRecyclerAdapter.MyViewHolder holder, final int position) {
            ...
            if(holder!=null){
                ...
                Glide.with(MainCategoryFragment.this).load(get.getHallnumber())
                        .thumbnail(0.5f)
                        .override(200,200).
           ...
           // @BindView(R.id.ratingbar)
            ...
            public MyViewHolder(View itemView, Context context, ArrayList<Listnew> halllist) {
               ...
               // halladd = (TextView) itemView.findViewById(R.id.halladdtext2);
                ...
                //discountprice=itemView.findViewById(R.id.quickbooking);
